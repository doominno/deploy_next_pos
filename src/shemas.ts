...
export const CouponReponseSchema = z.object({
...
export type ShoppingCart = z.infer<typeof ShoopingCartSchema>
export type CartItem = z.infer<typeof ShoopingCartContentsSchema>
export type Coupon = z.infer<typeof CouponReponseSchema>
