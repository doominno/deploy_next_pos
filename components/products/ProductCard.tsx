...
import { formatCurrency, getImagePatch, isAvailable } from "@/src/utils";
    ...
    return (
        ...
        >
            <div className={`${!isAvailable(product.inventory) && 'opacity-40'}`}>
                <Image
                    src={getImagePatch(product.image)}
            ...
            </div>
            {
                isAvailable(product.inventory) ? (
                    ...
                    bg-white opacity-60 w-full text-center py-5 text-2xl uppercase font-black"
                    >Agotado</p>
